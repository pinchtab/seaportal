...
candidate:1948157895 1 udp 2113937151 6970a8bd-5cc4-4362-80b5-0bdb26203ec3.local 60884 typ host generation 0 ufrag 1dwu network-cost 999

foundation/ip:

type & base ip: 1948157895
...
candidate:812579375 1 udp 1677729535 209.35.66.139 23786 typ srflx raddr 0.0.0.0 rport 0 generation 0 ufrag 1dwu network-cost 999

devices (3):

mic, audio, webcam

0.31ms **Timezone**07e7d0a6
...
0.73ms **Headless**3f0e0721

chromium: true

6% like headless: cd05ba62 ×
...
noContentIndex: false

noContactsManager: false
...
hasBadWebGL: undefined

platform hints:

0.11ms **Resistance**f163c83f
...
70.33ms ServiceWorkerGlobalScope
...
2.36ms **CSS Media Queries**5f09bc29
...
5.51ms **Computed Style**2b95363c
...
system styles: 3ee66549 ×

ActiveBorder: rgb(0, 0, 0)

ActiveCaption: rgb(0, 0, 0)

ActiveText: rgb(50, 145, 255)
...
rtt: 0, downlink: 1.6, max: Infinity
...
0.000022660955181663667

0.00002968724464835759
