...
candidate:3137529787 1 udp 2113937151 c569d7d4-c534-485a-abb6-0f5750460992.local 53346 typ host generation 0 ufrag LSWD network-cost 999

foundation/ip:

type & base ip: 3137529787
...
candidate:3597078624 1 udp 1677729535 209.35.66.139 23396 typ srflx raddr 0.0.0.0 rport 0 generation 0 ufrag LSWD network-cost 999

devices (3):

mic, audio, webcam

0.21ms **Timezone**7014c90a
...
contentDocument: fcdf065f

contentWindow: fcdf065f

createElement: fcdf065f

getElementById: fcdf065f

append: fcdf065f

insertAdjacentElement: fcdf065f

insertAdjacentHTML: fcdf065f

insertAdjacentText: fcdf065f

prepend: fcdf065f

replaceWith: fcdf065f

appendChild: fcdf065f

insertBefore: fcdf065f

replaceChild: fcdf065f
...
getImageData: fcdf065f

getByteFrequencyData: fcdf065f

getByteTimeDomainData: fcdf065f

getFloatFrequencyData: fcdf065f

getFloatTimeDomainData: fcdf065f

copyFromChannel: fcdf065f

getChannelData: fcdf065f

hardwareConcurrency: 330e9fcd

availHeight: 330e9fcd
...
55.22ms ServiceWorkerGlobalScope
...
1.98ms **CSS Media Queries**7ab905a8
...
3.76ms **Computed Style**be797546
...
0.00001671458466034892

0.00006696619624335653
